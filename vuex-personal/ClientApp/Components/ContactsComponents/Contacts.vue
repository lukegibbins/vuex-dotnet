...
<script>
  ...
  export default {
    ...
    // Used to demonstrate the functionality of a watcher.
    // Deep is used to look inside of an array for its properties to see if any have changed
    watch: {
      contacts: {
        deep: true,
        handler() {
          console.log("Watcher: contact data has changed");
        },
      }
    },
